...
const averageDailyAcres = totalAcres / totalDays ;
...
let fujiTons = [2, 3, 3, 2, 2, 2, 1];
let galaTons = [5, 2, 4, 3, 6, 2, 4];
let pinkTons = [1, 5, 4, 2, 1, 5, 4];
...
for (let i = 0; i < fujiTons.length; i++) {
    tonsFuji.push(fujiTons[i] * tonsPerAcre);
    tonsGala.push(galaTons[i] * tonsPerAcre);
    tonsPink.push(pinkTons[i] * tonsPerAcre);
}

console.log("Tons of Fuji:", tonsFuji);
console.log("Tons of Gala:", tonsGala);
console.log("Tons of Pink:", tonsPink);
